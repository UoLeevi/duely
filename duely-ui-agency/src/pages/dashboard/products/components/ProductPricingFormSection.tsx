...
export function ProductPricingFormSection<
  TFieldValues extends ProductPricingFormSectionFields
>({ form: _form }: ProductPricingFormSectionProps<TFieldValues>) {
  // TODO: fix types
  ...
  return (
    <>
      <FormField form={form} className="max-w-2xl" name="payment_type" type="radio-blocks" options={[
        { value: 'one_time', element: 'Single payment', description: 'Customers pay a one-time fee' },
