...
--
-- Name: query_resource_(text, jsonb, text, boolean, integer, text); Type: FUNCTION; Schema: operation_; Owner: postgres
--

CREATE FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _order_by text DEFAULT NULL::text, _desc boolean DEFAULT false, _limit integer DEFAULT NULL::integer, _after_id text DEFAULT NULL::text) RETURNS SETOF jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_$
DECLARE
  _desc_asc text;
...
ALTER FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _order_by text, _desc boolean, _limit integer, _after_id text) OWNER TO postgres;
