...
CREATE FUNCTION internal_.check_integration_config_data_() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  IF EXISTS (
...
ALTER FUNCTION internal_.check_integration_config_data_() OWNER TO postgres;
...
--
-- Name: query_resource_(text, jsonb, boolean, text, integer, text); Type: FUNCTION; Schema: operation_; Owner: postgres
--

CREATE FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _desc boolean DEFAULT false, _order_by text DEFAULT NULL::text, _limit integer DEFAULT NULL::integer, _after_id text DEFAULT NULL::text) RETURNS SETOF jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_$
DECLARE
  _desc_asc text;
...
ALTER FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _desc boolean, _order_by text, _limit integer, _after_id text) OWNER TO postgres;

--
-- Name: query_resource_(text, jsonb, text, boolean, text, integer, text); Type: FUNCTION; Schema: operation_; Owner: postgres
--

CREATE FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _token text, _desc boolean DEFAULT false, _order_by text DEFAULT NULL::text, _limit integer DEFAULT NULL::integer, _after_id text DEFAULT NULL::text) RETURNS SETOF jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_$
DECLARE
  _desc_asc text;
...
ALTER FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _token text, _desc boolean, _order_by text, _limit integer, _after_id text) OWNER TO postgres;
...
--
-- Name: owner_can_change_integration_config_(security_.resource_definition_, application_.resource_, jsonb); Type: FUNCTION; Schema: policy_; Owner: postgres
--

CREATE FUNCTION policy_.owner_can_change_integration_config_(_resource_definition security_.resource_definition_, _resource application_.resource_, _data jsonb) RETURNS text[]
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  IF internal_.check_resource_role_(_resource_definition, _resource, 'owner') THEN
...
ALTER FUNCTION policy_.owner_can_change_integration_config_(_resource_definition security_.resource_definition_, _resource application_.resource_, _data jsonb) OWNER TO postgres;
...
--
-- Name: owner_can_create_integration_config_(security_.resource_definition_, jsonb); Type: FUNCTION; Schema: policy_; Owner: postgres
--

CREATE FUNCTION policy_.owner_can_create_integration_config_(_resource_definition security_.resource_definition_, _data jsonb) RETURNS text[]
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  IF (
...
ALTER FUNCTION policy_.owner_can_create_integration_config_(_resource_definition security_.resource_definition_, _data jsonb) OWNER TO postgres;
...
--
-- Name: owner_can_query_integration_config_(security_.resource_definition_, application_.resource_); Type: FUNCTION; Schema: policy_; Owner: postgres
--
...
ALTER FUNCTION policy_.owner_can_query_integration_config_(_resource_definition security_.resource_definition_, _resource application_.resource_) OWNER TO postgres;
...
--
-- Name: serviceaccount_can_query_integration_config_(security_.resource_definition_, application_.resource_); Type: FUNCTION; Schema: policy_; Owner: postgres
--
...
ALTER FUNCTION policy_.serviceaccount_can_query_integration_config_(_resource_definition security_.resource_definition_, _resource application_.resource_) OWNER TO postgres;
...
--
-- Name: integration_config_; Type: TABLE; Schema: application_; Owner: postgres
--
...
ALTER TABLE application_.integration_config_ OWNER TO postgres;
...
CREATE TABLE internal_.form_field_ (
    ...
    hint_ text,
    required_ boolean DEFAULT false NOT NULL,
    prefix_ text,
    suffix_ text,
    audit_at_ timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    audit_session_uuid_ uuid DEFAULT (COALESCE(current_setting('security_.session_.uuid_'::text, true), '00000000-0000-0000-0000-000000000000'::text))::uuid NOT NULL
...
14ba3210-6a6a-4844-9726-f930611213cb	64617bc5-da98-474c-b406-f59dabe6f099	basic
968d4392-ed8b-40b9-9944-8cbe9d077917	5b44868d-82c1-492a-9ac2-91ed23277e70	basic-email
\.
...
64617bc5-da98-474c-b406-f59dabe6f099	2021-07-14 06:51:39.465047+00	00000000-0000-0000-0000-000000000000
5b44868d-82c1-492a-9ac2-91ed23277e70	2021-07-14 06:58:31.307956+00	00000000-0000-0000-0000-000000000000
d366a7fb-60b3-47d2-9dd2-15823c74fbf7	2021-07-14 07:09:54.400769+00	00000000-0000-0000-0000-000000000000
\.
...
COPY internal_.form_field_ (uuid_, name_, type_, form_uuid_, default_, label_, sort_key_, hint_, required_, prefix_, suffix_, audit_at_, audit_session_uuid_) FROM stdin;
087ecce8-4fcf-4471-ae4c-ab4d8660a114	headline1	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"{agency.name}"	Headline 1	1	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
0f3fa468-e427-4477-a409-8a695fbabe34	paragraph	textarea	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"Services"	Paragraph	4	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
3ea3f1de-0144-4819-9ce4-c9c04c12e6dc	headline2	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"Services"	Headline 2	2	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
b78b6a5b-9034-4fef-acb1-b9cd6982a0da	imageSrc	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	\N	Image URL	3	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
3964d6a5-ac11-49ac-9f19-5b392ba0770e	username	text	64617bc5-da98-474c-b406-f59dabe6f099	\N	Username	0	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
1aa9d741-7f4e-42a1-92be-922dc362833c	password	password	64617bc5-da98-474c-b406-f59dabe6f099	\N	Password	1	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
c86063df-9989-42f4-8000-22c15fbce340	email_address	email	5b44868d-82c1-492a-9ac2-91ed23277e70	\N	Email address	0	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
48de395c-53ca-4a53-ae40-0d94d10eb27b	password	password	5b44868d-82c1-492a-9ac2-91ed23277e70	\N	Password	1	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
c73098ad-183f-40b1-a96e-a314d56a6ed7	product_id	text	5126a7ce-f579-4da8-b2a8-ac9d13eff884	\N	Product ID	1	ID of the Teachable product	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
f3b235f6-e020-4f0c-a5e7-393877554407	school_domain	text	d366a7fb-60b3-47d2-9dd2-15823c74fbf7	\N	School domain name	0	Domain name of the Teachable school	t	https://	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000
\.
...
64617bc5-da98-474c-b406-f59dabe6f099	2021-07-14 06:51:39.465047+00	00000000-0000-0000-0000-000000000000	I
5b44868d-82c1-492a-9ac2-91ed23277e70	2021-07-14 06:58:31.307956+00	00000000-0000-0000-0000-000000000000	I
d366a7fb-60b3-47d2-9dd2-15823c74fbf7	2021-07-14 07:09:54.400769+00	00000000-0000-0000-0000-000000000000	I
\.
...
COPY internal__audit_.form_field_ (uuid_, name_, type_, form_uuid_, default_, label_, sort_key_, hint_, required_, prefix_, suffix_, audit_at_, audit_session_uuid_, audit_op_) FROM stdin;
087ecce8-4fcf-4471-ae4c-ab4d8660a114	headline1	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"{agency.name}"	Headline 1	1	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
0f3fa468-e427-4477-a409-8a695fbabe34	paragraph	textarea	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"Services"	Paragraph	4	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
3ea3f1de-0144-4819-9ce4-c9c04c12e6dc	headline2	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	"Services"	Headline 2	2	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
b78b6a5b-9034-4fef-acb1-b9cd6982a0da	imageSrc	text	63bb3010-4ed1-40bb-a029-e4501e3b0bd7	\N	Image URL	3	\N	f	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
3964d6a5-ac11-49ac-9f19-5b392ba0770e	username	text	64617bc5-da98-474c-b406-f59dabe6f099	\N	Username	0	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
1aa9d741-7f4e-42a1-92be-922dc362833c	password	password	64617bc5-da98-474c-b406-f59dabe6f099	\N	Password	1	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
c86063df-9989-42f4-8000-22c15fbce340	email_address	email	5b44868d-82c1-492a-9ac2-91ed23277e70	\N	Email address	0	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
48de395c-53ca-4a53-ae40-0d94d10eb27b	password	password	5b44868d-82c1-492a-9ac2-91ed23277e70	\N	Password	1	\N	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
f3b235f6-e020-4f0c-a5e7-393877554407	school_domain	text	d366a7fb-60b3-47d2-9dd2-15823c74fbf7	\N	School domain name	0	Domain name of the Teachable school	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
c73098ad-183f-40b1-a96e-a314d56a6ed7	product_id	text	5126a7ce-f579-4da8-b2a8-ac9d13eff884	\N	Product ID	1	ID of the Teachable product	t	\N	\N	2021-07-15 04:29:34.271094+00	00000000-0000-0000-0000-000000000000	I
...
--
-- Name: integration_config_ integration_config__name__agency_uuid__key; Type: CONSTRAINT; Schema: application_; Owner: postgres
--

ALTER TABLE ONLY application_.integration_config_
    ADD CONSTRAINT integration_config__name__agency_uuid__key UNIQUE (name_, agency_uuid_);


--
-- Name: integration_config_ integration_config__pkey; Type: CONSTRAINT; Schema: application_; Owner: postgres
--

ALTER TABLE ONLY application_.integration_config_
    ADD CONSTRAINT integration_config__pkey PRIMARY KEY (uuid_);
...
--
-- Name: integration_config_ tr_after_delete_resource_delete_; Type: TRIGGER; Schema: application_; Owner: postgres
--

CREATE TRIGGER tr_after_delete_resource_delete_ AFTER DELETE ON application_.integration_config_ REFERENCING OLD TABLE AS _old_table FOR EACH STATEMENT EXECUTE FUNCTION internal_.resource_delete_();
...
--
-- Name: integration_config_ tr_after_insert_resource_insert_; Type: TRIGGER; Schema: application_; Owner: postgres
--

CREATE TRIGGER tr_after_insert_resource_insert_ AFTER INSERT ON application_.integration_config_ REFERENCING NEW TABLE AS _new_table FOR EACH ROW EXECUTE FUNCTION internal_.resource_insert_();
...
--
-- Name: integration_config_ tr_after_update_resource_update_; Type: TRIGGER; Schema: application_; Owner: postgres
--

CREATE TRIGGER tr_after_update_resource_update_ AFTER UPDATE ON application_.integration_config_ REFERENCING NEW TABLE AS _new_table FOR EACH ROW EXECUTE FUNCTION internal_.resource_update_();
...
--
-- Name: integration_ integration__integration_config_uuid__fkey; Type: FK CONSTRAINT; Schema: application_; Owner: postgres
--

ALTER TABLE ONLY application_.integration_
    ADD CONSTRAINT integration__integration_config_uuid__fkey FOREIGN KEY (integration_config_uuid_) REFERENCES application_.integration_config_(uuid_);
...
ALTER TABLE ONLY application_.integration_config_
    ADD CONSTRAINT integration_config__agency_uuid__fkey FOREIGN KEY (agency_uuid_) REFERENCES application_.agency_(uuid_);


--
-- Name: integration_config_ integration_config__credential_uuid__fkey; Type: FK CONSTRAINT; Schema: application_; Owner: postgres
--

ALTER TABLE ONLY application_.integration_config_
    ADD CONSTRAINT integration_config__credential_uuid__fkey FOREIGN KEY (credential_uuid_) REFERENCES application_.credential_(uuid_);


--
-- Name: integration_config_ integration_config__integration_type_uuid__fkey; Type: FK CONSTRAINT; Schema: application_; Owner: postgres
--

ALTER TABLE ONLY application_.integration_config_
    ADD CONSTRAINT integration_config__integration_type_uuid__fkey FOREIGN KEY (integration_type_uuid_) REFERENCES internal_.integration_type_(uuid_);
...
--
-- Name: integration_type_ integration_type__config_form_uuid__fkey; Type: FK CONSTRAINT; Schema: internal_; Owner: postgres
--
