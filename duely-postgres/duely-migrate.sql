...
DROP FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _order_by text, _desc boolean, _limit integer, _after_id text);
...
DROP FUNCTION operation_.query_resource_(_resource_name text, _filter jsonb, _token text);
