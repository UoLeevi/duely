...
CALL internal_.drop_auditing_('application_.theme_');

ALTER TABLE application_.theme_ ALTER COLUMN color_primary_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_secondary_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_accent_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_background_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_surface_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_error_ DROP NOT NULL;
ALTER TABLE application_.theme_ ALTER COLUMN color_success_ DROP NOT NULL;
ALTER TABLE application_.theme_ DROP COLUMN standard_;

CALL internal_.setup_auditing_('application_.theme_');
