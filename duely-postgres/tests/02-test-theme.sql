-- psql -U duely -d duely -f tests/02-test-theme.sql
...
BEGIN
  ...
  BEGIN
    PERFORM operation_.query_resource_('theme', 'theme_0');
  ...
  SELECT * INTO _result_1 FROM operation_.query_resource_('theme', _result_1->>'id');
