-- psql -U duely -d duely -f tests/07-test-markdown.sql

\echo 'TEST 07 STARTED'
...
BEGIN
  ...
  BEGIN
    PERFORM operation_.delete_resource_(_resource_name, 'md_0');
  ...
  RAISE EXCEPTION 'TEST 07 PASSED' USING errcode = '40000'; -- transaction_rollback
