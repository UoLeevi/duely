...
export const Default = ({ backgroundText, content }) => {
  return (
    <Background>
      ...
      { backgroundText ||
        <>
          <span role="img" aria-label="" className="nowrap"> 🐶 🐱 🐭 🐹 🐰 🦊 🐻 🐼 🐨 🐯 🦁 🐮 🐷 🐽 🐸 🐵 🙈 🙉 🙊 🐒 🐔 🐧 🐦 🐤 🐣 🐥 🦆 🦅 🦉 🦇 🐺 🐗 🐴 🦄 🐝 🐛 🦋 🐌 🐞 </span><br/>
          <span role="img" aria-label="" className="nowrap"> 🐜 🦟 🦗 🕷 🕸 🦂 🐢 🐍 🦎 🦖 🦕 🐙 🦑 🦐 🦞 🦀 🐡 🐠 🐟 🐬 🐳 🐋 🦈 🐊 🐅 🐆 🦓 🦍 🦧 🐘 🦛 🦏 🐪 🐫 🦒 🦘 🐃 🐂 🐄 </span><br/>
          <span role="img" aria-label="" className="nowrap"> 🐎 🐖 🐏 🐑 🦙 🐐 🦌 🐕 🐩 🦮 🐕‍🦺 🐈 🐓 🦃 🦚 🦜 🦢 🦩 🕊 🐇 🦝 🦨 🦡 🦦 🦥 🐁 🐀 🐿 🦔 🐾 🐉 🐲 🌵 🎄 🌲 🌳 🌴 🌱 🌿 ☘️ </span>
        </>
      }
      </div>
      <div className="panel">
        <div className="panel-row pa-4">
          { content || <h2 className="default f-b">Background with cover</h2> }
        </div>
      </div>
    </Background>
  );
