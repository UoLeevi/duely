    ...
    <Background>
      ...
      <div className="panel">
        <div className="panel-row pa-4">
          { text('Content', '') || <h2 className="default f-b">Background with cover</h2> }
        </div>
      </div>
    </Background>
  );
...
export const SVG = () => {
  return (
    <Background contain scale={ number('scale', 0.8) || 1.0 }>
      ...
      <div className="panel">
        <div className="panel-row pa-4">
          { text('Content', '') || <h2 className="default f-b">Background with contain</h2> }
        </div>
      </div>
    </Background>
  );
