...
const NavButton = ({ link, text, icon, tag = 'button', minimize = false, ...props }) => {
  ...
  return (
    <Element className="nav-button surface color-s1n color-l1" data-minimized={ minimize } data-active={ active } { ...props }>
