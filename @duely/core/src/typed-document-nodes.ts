...
export type MutationUpdate_IntegrationArgs = {
  ...
  credential_id?: Maybe<Scalars['ID']>;
  integration_type?: Maybe<Scalars['ID']>;
  data?: Maybe<Scalars['Json']>;
};
