...
function toFlagEmoji(alpha2Code) {
    ...
    return String.fromCodePoint(c1.codePointAt(0) + 0x1F1E6 - 0x41, c2.codePointAt(0) + 0x1F1E6 - 0x41);
}
function countryByCode(alpha2code) {
    // https://www.iban.com/country-codes
    return Object.assign({ alpha2code, flag: toFlagEmoji(alpha2code) }, countries[alpha2code]);
}
function processImageFile(file, options = { estimateColor: true }) {
    return __awaiter(this, void 0, void 0, function* () {
        const imageFile = yield processFile(file);
        if (options.estimateColor) {
...
function formatCurrency(amount, currency, country_code) {
    ...
    country_code = country_code !== null && country_code !== void 0 ? country_code : 'US';
...
function truncate(text, maxLength) {
    return (text === null || text === void 0 ? void 0 : text.length) > maxLength
...
function DropMenuItems({ children, close, buttonRef }) {
    ...
    return (react_1.default.createElement("div", { ref: ref, tabIndex: "-1", className: "absolute right-0 z-10 flex flex-col px-4 py-2 space-y-2 bg-white border rounded-md shadow-md focus:outline-none", onBlur: onBlur }, children));
}
...
const LoadingSpinner_1 = __webpack_require__(11);
function Button(_a) {
    var { children, type, disabled, loading, spinner, className } = _a, props = __rest(_a, ["children", "type", "disabled", "loading", "spinner", "className"]);
    disabled = !!(disabled || loading);
    className = util_1.Util.createClassName('relative inline-flex justify-center items-center appearance-none rounded-md font-medium leading-5 transition duration-150 ease-in-out focus:outline-none focus-visible:outline-none focus-visible:ring shadow-sm border border-transparent', spinner && 'px-9', className);
    return (react_1.default.createElement("button", Object.assign({ type: type, disabled: disabled, className: className }, props),
...
//# sourceMappingURL=duely-react.js.map