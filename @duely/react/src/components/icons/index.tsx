...
const iconPathDefinitions = {
  ...
  'arrow-sm-down': {
    ...
    outline: ['M17 13l-5 5m0 0l-5-5m5 5V6']
  },
  briefcase: {
    solid: [
  ...
  'plus-sm': {
    ...
    outline: ['M12 6v6m0 0v6m0-6h6m-6 0H6']
  },
  check: {
    solid: [
  ...
  'external-link': {
    ...
    outline: ['M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14']
  },
